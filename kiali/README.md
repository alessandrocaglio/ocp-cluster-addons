# Red Hat Kiali Helm Chart for ArgoCD
...
1. **Installs the Kiali Operator**.

## Usage

To use this Helm chart with ArgoCD, you can refer to the [application-kiali.yaml](application-kiali.yaml) file provided in this repository.
